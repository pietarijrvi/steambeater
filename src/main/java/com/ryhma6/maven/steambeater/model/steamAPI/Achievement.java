...
public class Achievement {
	/**
	 * Name of the achievement in api format that is used for accessing the game
	 * data
	 * 
	...
	/**
	 * Whether or not the achievement has been completed (completed: 1, not
	 * completed: 0)
	 * 
	 * @param achieved Achievement completion status from SteamAPI (completed: 1,
	 *                 not completed: 0)
	 * @return Completion status of this achievement (completed: 1, not completed:
	 *         0)
	 */
	@Getter
	@Setter
	...
	/**
	 * Unlock timestamp (unix). Defaults to "0" if achievement was not unlocked or
	 * time is unknown.
	 * 
